...
![边端一体机大模型推理优化方向招募封面](recruiting-cover-final.png)
...
![从应用到芯片的边端大模型推理全栈技术方向](tech-map-final.png)
...
![从 0 到 1 的 AI Infra 成长路径](growth-path-final.png)
...
![加入团队可以获得的六项价值](team-values-final.png)
